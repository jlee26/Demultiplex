...
def rev_comp(seq: str) -> str:
    '''Takes in a string of DNA from 5' to 3' and returns the reverse compliment starting from 5' to 3'.'''
    seq = seq[::-1]
    size = len(seq)
    rev_seq = ""
    for i in range(size):
...
if __name__ == "__main__":
    assert rev_comp("ATCGGC") == "GCCGAT"
    assert gc_content("ATCG") == "CGAT"
    assert gc_content("CCGGTTAA") == "TTAACCGG"
    print("rev_comp correctly reverse complimented and printed from 5' to 3'!")